...
enum opt_code
{
  ...
  OPT_march_ = 1295,                         /* -march= */
  OPT_masm_ = 1296,                          /* -masm= */
  OPT_mavx = 1297,                           /* -mavx */
  OPT_mavx2 = 1298,                          /* -mavx2 */
  OPT_mavx256_split_unaligned_load = 1299,   /* -mavx256-split-unaligned-load */
  OPT_mavx256_split_unaligned_store = 1300,  /* -mavx256-split-unaligned-store */
  OPT_mavx5124fmaps = 1301,                  /* -mavx5124fmaps */
  OPT_mavx5124vnniw = 1302,                  /* -mavx5124vnniw */
  OPT_mavx512bitalg = 1303,                  /* -mavx512bitalg */
  OPT_mavx512bw = 1304,                      /* -mavx512bw */
  OPT_mavx512cd = 1305,                      /* -mavx512cd */
  OPT_mavx512dq = 1306,                      /* -mavx512dq */
  OPT_mavx512er = 1307,                      /* -mavx512er */
  OPT_mavx512f = 1308,                       /* -mavx512f */
  OPT_mavx512ifma = 1309,                    /* -mavx512ifma */
  OPT_mavx512pf = 1310,                      /* -mavx512pf */
  OPT_mavx512vbmi = 1311,                    /* -mavx512vbmi */
  OPT_mavx512vbmi2 = 1312,                   /* -mavx512vbmi2 */
  OPT_mavx512vl = 1313,                      /* -mavx512vl */
  OPT_mavx512vnni = 1314,                    /* -mavx512vnni */
  OPT_mavx512vpopcntdq = 1315,               /* -mavx512vpopcntdq */
  OPT_mbmi = 1316,                           /* -mbmi */
  OPT_mbmi2 = 1317,                          /* -mbmi2 */
  OPT_mbranch_cost_ = 1318,                  /* -mbranch-cost= */
  OPT_mcall_ms2sysv_xlogues = 1319,          /* -mcall-ms2sysv-xlogues */
  OPT_mcet_switch = 1320,                    /* -mcet-switch */
  OPT_mcld = 1321,                           /* -mcld */
  OPT_mcldemote = 1322,                      /* -mcldemote */
  OPT_mclflushopt = 1323,                    /* -mclflushopt */
  OPT_mclwb = 1324,                          /* -mclwb */
  OPT_mclzero = 1325,                        /* -mclzero */
  OPT_mcmodel_ = 1326,                       /* -mcmodel= */
  /* OPT_mcpu_ = 1327, */                    /* -mcpu= */
  OPT_mcrc32 = 1328,                         /* -mcrc32 */
  OPT_mcx16 = 1329,                          /* -mcx16 */
  OPT_mdispatch_scheduler = 1330,            /* -mdispatch-scheduler */
  OPT_mdump_tune_features = 1331,            /* -mdump-tune-features */
  OPT_mf16c = 1332,                          /* -mf16c */
  OPT_mfancy_math_387 = 1333,                /* -mfancy-math-387 */
  OPT_mfentry = 1334,                        /* -mfentry */
  OPT_mfentry_name_ = 1335,                  /* -mfentry-name= */
  OPT_mfentry_section_ = 1336,               /* -mfentry-section= */
  OPT_mfma = 1337,                           /* -mfma */
  OPT_mfma4 = 1338,                          /* -mfma4 */
  OPT_mforce_drap = 1339,                    /* -mforce-drap */
  OPT_mforce_indirect_call = 1340,           /* -mforce-indirect-call */
  OPT_mfp_ret_in_387 = 1341,                 /* -mfp-ret-in-387 */
  OPT_mfpmath_ = 1342,                       /* -mfpmath= */
  OPT_mfsgsbase = 1343,                      /* -mfsgsbase */
  OPT_mfunction_return_ = 1344,              /* -mfunction-return= */
  /* OPT_mfused_madd = 1345, */              /* -mfused-madd */
  OPT_mfxsr = 1346,                          /* -mfxsr */
  OPT_mgeneral_regs_only = 1347,             /* -mgeneral-regs-only */
  OPT_mgfni = 1348,                          /* -mgfni */
  OPT_mhard_float = 1349,                    /* -mhard-float */
  OPT_mhle = 1350,                           /* -mhle */
  OPT_miamcu = 1351,                         /* -miamcu */
  OPT_mieee_fp = 1352,                       /* -mieee-fp */
  OPT_mincoming_stack_boundary_ = 1353,      /* -mincoming-stack-boundary= */
  OPT_mindirect_branch_register = 1354,      /* -mindirect-branch-register */
  OPT_mindirect_branch_ = 1355,              /* -mindirect-branch= */
  OPT_minline_all_stringops = 1356,          /* -minline-all-stringops */
  OPT_minline_stringops_dynamically = 1357,  /* -minline-stringops-dynamically */
  OPT_minstrument_return_ = 1358,            /* -minstrument-return= */
  /* OPT_mintel_syntax = 1359, */            /* -mintel-syntax */
  OPT_mlarge_data_threshold_ = 1360,         /* -mlarge-data-threshold= */
  OPT_mlong_double_128 = 1361,               /* -mlong-double-128 */
  OPT_mlong_double_64 = 1362,                /* -mlong-double-64 */
  OPT_mlong_double_80 = 1363,                /* -mlong-double-80 */
  OPT_mlwp = 1364,                           /* -mlwp */
  OPT_mlzcnt = 1365,                         /* -mlzcnt */
  OPT_mmanual_endbr = 1366,                  /* -mmanual-endbr */
  OPT_mmemcpy_strategy_ = 1367,              /* -mmemcpy-strategy= */
  OPT_mmemset_strategy_ = 1368,              /* -mmemset-strategy= */
  OPT_mmitigate_rop = 1369,                  /* -mmitigate-rop */
  OPT_mmmx = 1370,                           /* -mmmx */
  OPT_mmovbe = 1371,                         /* -mmovbe */
  OPT_mmovdir64b = 1372,                     /* -mmovdir64b */
  OPT_mmovdiri = 1373,                       /* -mmovdiri */
  OPT_mmpx = 1374,                           /* -mmpx */
  OPT_mms_bitfields = 1375,                  /* -mms-bitfields */
  OPT_mmwaitx = 1376,                        /* -mmwaitx */
  OPT_mno_align_stringops = 1377,            /* -mno-align-stringops */
  OPT_mno_default = 1378,                    /* -mno-default */
  OPT_mno_fancy_math_387 = 1379,             /* -mno-fancy-math-387 */
  OPT_mno_push_args = 1380,                  /* -mno-push-args */
  OPT_mno_red_zone = 1381,                   /* -mno-red-zone */
  OPT_mno_sse4 = 1382,                       /* -mno-sse4 */
  OPT_mnop_mcount = 1383,                    /* -mnop-mcount */
  OPT_momit_leaf_frame_pointer = 1384,       /* -momit-leaf-frame-pointer */
  OPT_mpc32 = 1385,                          /* -mpc32 */
  OPT_mpc64 = 1386,                          /* -mpc64 */
  OPT_mpc80 = 1387,                          /* -mpc80 */
  OPT_mpclmul = 1388,                        /* -mpclmul */
  OPT_mpcommit = 1389,                       /* -mpcommit */
  OPT_mpconfig = 1390,                       /* -mpconfig */
  OPT_mpku = 1391,                           /* -mpku */
  OPT_mpopcnt = 1392,                        /* -mpopcnt */
  /* OPT_mprefer_avx128 = 1393, */           /* -mprefer-avx128 */
  OPT_mprefer_vector_width_ = 1394,          /* -mprefer-vector-width= */
  OPT_mpreferred_stack_boundary_ = 1395,     /* -mpreferred-stack-boundary= */
  OPT_mprefetchwt1 = 1396,                   /* -mprefetchwt1 */
  OPT_mprfchw = 1397,                        /* -mprfchw */
  OPT_mptwrite = 1398,                       /* -mptwrite */
  OPT_mpush_args = 1399,                     /* -mpush-args */
  OPT_mrdpid = 1400,                         /* -mrdpid */
  OPT_mrdrnd = 1401,                         /* -mrdrnd */
  OPT_mrdseed = 1402,                        /* -mrdseed */
  OPT_mrecip = 1403,                         /* -mrecip */
  OPT_mrecip_ = 1404,                        /* -mrecip= */
  OPT_mrecord_mcount = 1405,                 /* -mrecord-mcount */
  OPT_mrecord_return = 1406,                 /* -mrecord-return */
  OPT_mred_zone = 1407,                      /* -mred-zone */
  OPT_mregparm_ = 1408,                      /* -mregparm= */
  OPT_mrtd = 1409,                           /* -mrtd */
  OPT_mrtm = 1410,                           /* -mrtm */
  OPT_msahf = 1411,                          /* -msahf */
  OPT_msgx = 1412,                           /* -msgx */
  OPT_msha = 1413,                           /* -msha */
  OPT_mshstk = 1414,                         /* -mshstk */
  OPT_mskip_rax_setup = 1415,                /* -mskip-rax-setup */
  OPT_msoft_float = 1416,                    /* -msoft-float */
  OPT_msse = 1417,                           /* -msse */
  OPT_msse2 = 1418,                          /* -msse2 */
  OPT_msse2avx = 1419,                       /* -msse2avx */
  OPT_msse3 = 1420,                          /* -msse3 */
  OPT_msse4 = 1421,                          /* -msse4 */
  OPT_msse4_1 = 1422,                        /* -msse4.1 */
  OPT_msse4_2 = 1423,                        /* -msse4.2 */
  OPT_msse4a = 1424,                         /* -msse4a */
  /* OPT_msse5 = 1425, */                    /* -msse5 */
  OPT_msseregparm = 1426,                    /* -msseregparm */
  OPT_mssse3 = 1427,                         /* -mssse3 */
  OPT_mstack_arg_probe = 1428,               /* -mstack-arg-probe */
  OPT_mstack_protector_guard_offset_ = 1429, /* -mstack-protector-guard-offset= */
  OPT_mstack_protector_guard_reg_ = 1430,    /* -mstack-protector-guard-reg= */
  OPT_mstack_protector_guard_symbol_ = 1431, /* -mstack-protector-guard-symbol= */
  OPT_mstack_protector_guard_ = 1432,        /* -mstack-protector-guard= */
  OPT_mstackrealign = 1433,                  /* -mstackrealign */
  OPT_mstringop_strategy_ = 1434,            /* -mstringop-strategy= */
  OPT_mstv = 1435,                           /* -mstv */
  OPT_mtbm = 1436,                           /* -mtbm */
  OPT_mtls_dialect_ = 1437,                  /* -mtls-dialect= */
  OPT_mtls_direct_seg_refs = 1438,           /* -mtls-direct-seg-refs */
  OPT_mtune_ctrl_ = 1439,                    /* -mtune-ctrl= */
  OPT_mtune_ = 1440,                         /* -mtune= */
  OPT_mvaes = 1441,                          /* -mvaes */
  OPT_mveclibabi_ = 1442,                    /* -mveclibabi= */
  OPT_mvect8_ret_in_mem = 1443,              /* -mvect8-ret-in-mem */
  OPT_mvpclmulqdq = 1444,                    /* -mvpclmulqdq */
  OPT_mvzeroupper = 1445,                    /* -mvzeroupper */
  OPT_mwaitpkg = 1446,                       /* -mwaitpkg */
  OPT_mwbnoinvd = 1447,                      /* -mwbnoinvd */
  OPT_mx32 = 1448,                           /* -mx32 */
  OPT_mxop = 1449,                           /* -mxop */
  OPT_mxsave = 1450,                         /* -mxsave */
  OPT_mxsavec = 1451,                        /* -mxsavec */
  OPT_mxsaveopt = 1452,                      /* -mxsaveopt */
  OPT_mxsaves = 1453,                        /* -mxsaves */
  OPT_n = 1454,                              /* -n */
  OPT_no_canonical_prefixes = 1455,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1456,              /* -no-integrated-cpp */
  OPT_no_pie = 1457,                         /* -no-pie */
  OPT_nocpp = 1458,                          /* -nocpp */
  OPT_nodefaultlibs = 1459,                  /* -nodefaultlibs */
  OPT_nolibc = 1460,                         /* -nolibc */
  OPT_nophoboslib = 1461,                    /* -nophoboslib */
  OPT_nostartfiles = 1462,                   /* -nostartfiles */
  OPT_nostdinc = 1463,                       /* -nostdinc */
  OPT_nostdinc__ = 1464,                     /* -nostdinc++ */
  OPT_nostdlib = 1465,                       /* -nostdlib */
  OPT_o = 1466,                              /* -o */
  OPT_p = 1467,                              /* -p */
  OPT_pass_exit_codes = 1468,                /* -pass-exit-codes */
  /* OPT_pedantic = 1469, */                 /* -pedantic */
  OPT_pedantic_errors = 1470,                /* -pedantic-errors */
  OPT_pg = 1471,                             /* -pg */
  OPT_pie = 1472,                            /* -pie */
  OPT_pipe = 1473,                           /* -pipe */
  OPT_print_file_name_ = 1474,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1475,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1476,          /* -print-multi-directory */
  OPT_print_multi_lib = 1477,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1478,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1479,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1480,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1481,               /* -print-prog-name= */
  OPT_print_search_dirs = 1482,              /* -print-search-dirs */
  OPT_print_sysroot = 1483,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1484,   /* -print-sysroot-headers-suffix */
  OPT_quiet = 1485,                          /* -quiet */
  OPT_r = 1486,                              /* -r */
  OPT_remap = 1487,                          /* -remap */
  OPT_s = 1488,                              /* -s */
  OPT_save_temps = 1489,                     /* -save-temps */
  OPT_save_temps_ = 1490,                    /* -save-temps= */
  OPT_shared = 1491,                         /* -shared */
  OPT_shared_libgcc = 1492,                  /* -shared-libgcc */
  OPT_shared_libphobos = 1493,               /* -shared-libphobos */
  /* OPT_specs = 1494, */                    /* -specs */
  OPT_specs_ = 1495,                         /* -specs= */
  OPT_static = 1496,                         /* -static */
  OPT_static_libasan = 1497,                 /* -static-libasan */
  OPT_static_libgcc = 1498,                  /* -static-libgcc */
  OPT_static_libgfortran = 1499,             /* -static-libgfortran */
  OPT_static_libgo = 1500,                   /* -static-libgo */
  OPT_static_liblsan = 1501,                 /* -static-liblsan */
  OPT_static_libmpx = 1502,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1503,          /* -static-libmpxwrappers */
  OPT_static_libphobos = 1504,               /* -static-libphobos */
  OPT_static_libstdc__ = 1505,               /* -static-libstdc++ */
  OPT_static_libtsan = 1506,                 /* -static-libtsan */
  OPT_static_libubsan = 1507,                /* -static-libubsan */
  OPT_static_pie = 1508,                     /* -static-pie */
  /* OPT_std_c__03 = 1509, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1510, */                /* -std=c++0x */
  OPT_std_c__11 = 1511,                      /* -std=c++11 */
  OPT_std_c__14 = 1512,                      /* -std=c++14 */
  OPT_std_c__17 = 1513,                      /* -std=c++17 */
  /* OPT_std_c__1y = 1514, */                /* -std=c++1y */
  /* OPT_std_c__1z = 1515, */                /* -std=c++1z */
  OPT_std_c__2a = 1516,                      /* -std=c++2a */
  OPT_std_c__98 = 1517,                      /* -std=c++98 */
  OPT_std_c11 = 1518,                        /* -std=c11 */
  OPT_std_c17 = 1519,                        /* -std=c17 */
  /* OPT_std_c18 = 1520, */                  /* -std=c18 */
  /* OPT_std_c1x = 1521, */                  /* -std=c1x */
  OPT_std_c2x = 1522,                        /* -std=c2x */
  /* OPT_std_c89 = 1523, */                  /* -std=c89 */
  OPT_std_c90 = 1524,                        /* -std=c90 */
  OPT_std_c99 = 1525,                        /* -std=c99 */
  /* OPT_std_c9x = 1526, */                  /* -std=c9x */
  OPT_std_f2003 = 1527,                      /* -std=f2003 */
  OPT_std_f2008 = 1528,                      /* -std=f2008 */
  OPT_std_f2008ts = 1529,                    /* -std=f2008ts */
  OPT_std_f2018 = 1530,                      /* -std=f2018 */
  OPT_std_f95 = 1531,                        /* -std=f95 */
  OPT_std_gnu = 1532,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1533, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1534, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1535,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1536,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 1537,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1538, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 1539, */              /* -std=gnu++1z */
  OPT_std_gnu__2a = 1540,                    /* -std=gnu++2a */
  OPT_std_gnu__98 = 1541,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1542,                      /* -std=gnu11 */
  OPT_std_gnu17 = 1543,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 1544, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 1545, */                /* -std=gnu1x */
  OPT_std_gnu2x = 1546,                      /* -std=gnu2x */
  /* OPT_std_gnu89 = 1547, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1548,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1549,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1550, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1551, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1552,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1553, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1554, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1555, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 1556, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 1557, */         /* -std=iso9899:2018 */
  OPT_std_legacy = 1558,                     /* -std=legacy */
  OPT_symbolic = 1559,                       /* -symbolic */
  OPT_t = 1560,                              /* -t */
  OPT_time = 1561,                           /* -time */
  OPT_time_ = 1562,                          /* -time= */
  OPT_traditional = 1563,                    /* -traditional */
  OPT_traditional_cpp = 1564,                /* -traditional-cpp */
  OPT_trigraphs = 1565,                      /* -trigraphs */
  OPT_u = 1566,                              /* -u */
  OPT_undef = 1567,                          /* -undef */
  OPT_v = 1568,                              /* -v */
  OPT_version = 1569,                        /* -version */
  OPT_w = 1570,                              /* -w */
  OPT_wrapper = 1571,                        /* -wrapper */
  OPT_x = 1572,                              /* -x */
  OPT_z = 1573,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
